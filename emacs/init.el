...
;; Projectile
(with-load 'projectile-autoloads
  (projectile-global-mode t))

(with-load 'projectile
  (with-load 'helm
...
(with-load 'helm
  ...
  (with-load 'evil-leader
    (evil-leader/set-key "pf" 'helm-find-files)
    (evil-leader/set-key "pb" 'helm-buffers-list)))
